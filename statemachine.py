...
class MatchSearcher(object):
    ...
    def __init__(self, filename, topdown=True, wrong_color_block_limit=1):
        ...
        if self.topdown:
            ...
            self.machine.add_transition(source='Searching', trigger='foundWhite',    dest='WhiteDetected', before='rememberEnd')
            self.machine.add_transition(source='Searching', trigger='foundOther',    dest='Searching')
            self.machine.add_transition(source='Searching', trigger='foundColumnEnd', dest='Searching')
            ...
            self.machine.add_transition(source='WhiteRedBlueDetected', trigger='foundBlue',   dest='WhiteRedBlueDetected', before='rememberStart')
            ...
            self.machine.add_transition(source='WhiteRedYellowDetected', trigger='foundYellow', dest='WhiteRedYellowDetected', before='rememberStart')
            ...
            self.machine.add_transition(source='WhiteYellowRedDetected',  trigger='foundRed',    dest='WhiteYellowRedDetected', before='rememberStart')
            ...
            self.machine.add_transition(source='WhiteYellowBlueDetected', trigger='foundBlue',   dest='WhiteYellowBlueDetected', before='rememberStart')
            ...
            self.machine.add_transition(source='WhiteBlueYellowDetected', trigger='foundYellow', dest='WhiteBlueYellowDetected', before='rememberStart')
